...
WebUI.setText(findTestObject('Object Repository/Page_Droobi Hospital Portal/input_Name_name'), GlobalVariable.G_diet + rand)
...
WebUI.setText(findTestObject('Object Repository/Page_Droobi Hospital Portal/input_Email Address_email'), (GlobalVariable.G_diet + 
    rand) + '@gmail.com')
