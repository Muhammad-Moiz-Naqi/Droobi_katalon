...
WebUI.click(findTestObject('Object Repository/Add health Professional dfrom admin portal/Page_Droobi Admin Portal/li_Health Professionals'))

WebUI.click(findTestObject('Object Repository/Add health Professional dfrom admin portal/Page_Droobi Admin Portal/button_Add Health Professional'))
