...
WebUI.click(findTestObject('Object Repository/Page_Droobi Admin Portal/button_Add Hospital'))
...
def admin = ('moiz.naqi+' + ran_no) + '@venturedive.com'

WebUI.setText(findTestObject('Page_Droobi Admin Portal/input_Email Address_email0'), admin)
