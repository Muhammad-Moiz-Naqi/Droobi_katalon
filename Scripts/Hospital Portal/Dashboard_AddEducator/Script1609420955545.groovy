...
WebUI.click(findTestObject('Page_Droobi Hospital Portal/li_Educator'))

WebUI.setText(findTestObject('Object Repository/Page_Droobi Hospital Portal/input_Name_name'), GlobalVariable.G_educator + 
    rand)
...
WebUI.setText(findTestObject('Object Repository/Page_Droobi Hospital Portal/input_Email Address_email'), (GlobalVariable.G_educator + 
    rand) + '@gmail.com')
