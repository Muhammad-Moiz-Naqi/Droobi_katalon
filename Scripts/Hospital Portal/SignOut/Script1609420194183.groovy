...
WebUI.click(findTestObject('Object Repository/Page_Droobi Hospital Portal/span_Sign Out'))

WebUI.verifyElementPresent(findTestObject('Page_Droobi Hospital Portal/p_Hello, please sign in'), 0)
