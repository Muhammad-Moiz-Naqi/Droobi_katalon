...
WebUI.setText(findTestObject('Object Repository/Page_Droobi Admin Portal/Page_Droobi Admin Portal/input_Email Address_email0'), 
    GlobalVariable.Dup_email)

WebUI.click(findTestObject('Object Repository/Page_Droobi Admin Portal/Page_Droobi Admin Portal/button_Add Hospital  Invite Admin(s)'))
...
WebUI.verifyEqual(findTestObject('Error Validation/Page_Droobi Admin Portal/Page_Droobi Admin Portal/span_Sorry, there is already a Hospital Admin with that email address'), 
    'Sorry, there is already a Hospital Admin with thas email address')
