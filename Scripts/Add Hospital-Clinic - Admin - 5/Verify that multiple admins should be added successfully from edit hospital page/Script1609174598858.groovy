...
WebUI.setText(findTestObject('Add multiple admins/Page_Droobi Admin Portal/Admin email 0'), ('moiznaqi+' + ran_no) + '@venturedive.com')

WebUI.click(findTestObject('Object Repository/Add multiple admins/Page_Droobi Admin Portal/Page_Droobi Admin Portal/button_ Add Another Admin'))

WebUI.setText(findTestObject('Add multiple admins/Page_Droobi Admin Portal/Admin email 0'), ('moiznaqi+' + ran_no) + '@venturedive.com')

WebUI.setText(findTestObject('Object Repository/Add multiple admins/Page_Droobi Admin Portal/Page_Droobi Admin Portal/input_Email Address_email2'), 
    'moiznaqi+1115@venturedive.com')
