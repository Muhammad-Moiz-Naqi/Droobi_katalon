...
WebUI.click(findTestObject('Admin is able to see al pages/Refferal codes/div_19'))

WebUI.click(findTestObject('Object Repository/Admin is able to see al pages/Refferal codes/button_Cancel'))
