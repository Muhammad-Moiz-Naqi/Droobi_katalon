...
WebUI.click(findTestObject('Object Repository/Page_Droobi Hospital Portal/button_Continue (14)'))
...
WebUI.setText(findTestObject('Object Repository/Page_Droobi Hospital Portal/input_Name_name'), GlobalVariable.G_professional_doctor + 
    rand)
...
WebUI.setText(findTestObject('Object Repository/Page_Droobi Hospital Portal/input_Email Address_email'), (GlobalVariable.G_professional_doctor_email + 
    rand) + '@gmail.com')
